...
https://send.sdad.pro | 2GiB | 7 days | 100 | | India 🇮🇳 | ![version](https://img.shields.io/badge/dynamic/json?label=version&query=version&url=https://send.sdad.pro/__version__) | ![Uptime (90 days)](https://img.shields.io/uptimerobot/ratio/90/ADD_YOUR_MONITOR_ID)
...
2. Either select one of the existing Send accounts from the list or click the
